...
call s:hi("Directory", s:light_blue, s:color_none, s:attr_none)
...
call s:hi("LineNr", s:black, s:color_none, s:attr_none)
...
call s:hi("GitSignsChange", s:light_blue, s:color_none, s:attr_none)
